...
const excludeList = [
    'color', 'useColorTemperature', 'colorTemperature', 'size',
    'range', 'term', 'luminance', 'luminousPower', 'staticSettings',
];
...
// dump.value.term.value && (!dumps || dumps.every(item => !!item.value.term.value))
